...
_(UI, dashboards, visualizations, layouts, forms)_
...
_(REST APIs, GraphQL, CLIs, webhooks, SDKs, internal service interfaces)_
...
_(Background jobs, cron tasks, scripts, CLI tools, services, pipelines)_
...
_(Documentation, emails, reports, notifications, changelogs, READMEs)_
...
_(Data models, file layouts, taxonomies, naming conventions, configuration schemas)_
...
_(Apply to any domain type when relevant)_
