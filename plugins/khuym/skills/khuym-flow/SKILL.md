...
| --- | ---------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| 1   | `khuym-flow`          | This file. Routing, go mode, red flags.                                | Starting any session                                                      |
...
| 9   | `khuym-writing-skills` | TDD-for-skills: RED-GREEN-REFACTOR + persuasion psychology             | Improving or creating khuym skills themselves                             |
...
| "Improve khuym itself"                     | `khuym-writing-skills`         | Load directly                               |
